package net.estebanrodriguez.apps.popularmovies.view;
...
import net.estebanrodriguez.apps.popularmovies.data_access.MovieDataParser;
...
public class GridViewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            MovieItemFactory.buildMovieList(MovieDataParser.parseJsonMovieDataString(task.get()));
